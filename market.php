...
<body class="bg-info">
	...
	<button type="button" class="btn btn-light"><a href="editmarket.php">Lisa uus kuulutus</a></button><br><br>
	<button type="button" class="btn btn-light"><a href="userAds.php">Vaata enda kuulutusi</a></button><br><br>
	</div>
	<div class="col-sm-8">
